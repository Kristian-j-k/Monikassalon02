...
public class Database {
    ...
    public void addUser(String name, String gender, String email, int phoneNumber , String password , Boolean worker ) {
        String sql = "INSERT INTO USER( name, gender , email, phoneNumber, password, worker, createdDate )\n" +
                "VALUES ('"+name+" ', '"+gender+"' , '"+email+"' ,'"+phoneNumber+"' , "+password+" , "+worker+" ,date('now'))";
        DbsqlUpdate(sql);
    }
