...
@FXML
    ...
    public static User createNewUser(String name, String gender, String email, int phoneNumber, String password , Boolean isWorker ){
        Database d = new Database();
        d.addUser(name,gender,email,phoneNumber,password,isWorker);
